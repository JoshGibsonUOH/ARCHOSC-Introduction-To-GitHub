...
<p>If this happens click settings -> general and then scroll all the way down to the bottom until you see the "repository visibility" section. Click change visibility and then set to public - this should then give you full access to the GitHub pages section. 
    </div>
</div>

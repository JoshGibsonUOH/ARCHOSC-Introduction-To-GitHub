...
## Section 1: Creating A Local Repository
## What is GitHub?
...
Name your folder "ArchOSC Assignment" and click anywhere in the explorer window. When you are done it should look like the image below.

![Image](Pictures/009.png)

You should then, as you did last week, go into this folder and create another folder called "Pictures" that will be used to store your screenshots
...
<p>Part 1: Open a Microsoft Word Document and give it the title "Lab 2 Placeholder"</p>
<p>Part 2: Take a screenshot of inside of your newly created lab folder, including the "Pictures" folder you have just created - it should look like the screenshot above, with both the path to your Worskspace and the folder showing - you should paste this screenshot into paint, edit it if needed and then save it to you "Pictures folder" as you did last week. - I would get into the habit of naming them with clear names (such as the order you did them or what they show) this will make it easier to place them on your website later. </p>
<p>Part 3: In your Lab 2 Placeholder document write a small explaination of what you just did.</p>
    </div>
</div>
...
<p>You should add a screenshot of your terminal showing you enter the git init command to your pictures folder, with an explaination of what you did in your word document.</p>
    </div>
</div>
...
Repository name: Set to ARCHOSC-Assignment-YourNameHere
...
<p>You should add a screenshot of your created repository to your pictures folder, with an explaination of what you did in your word document.</p>
    </div>
</div>
...
When you have created the creation of your repository on GitHub you then need to navigate back to the terminal and enter the following command:
...
<p>You should add a screenshot of your terminal showing you adding your GitHub repository as a remote repository to your pictures folder, and explaining what you did in your working document.</p>
    </div>
</div>
...
Name your file "index.html" and press save, your file should look like the image below before you save.
...
<p>You should add a screenshot of the completed website to your pictures folder, with an explaination of what you did in your document.</p>
    </div>
</div>
...
<p>You should add a screenshot of your terminal showing you completing this commit to your pictures folder, with an explaination of what you did in your working document.</p>
    </div>
</div>
...
## Section 4: Pushing Your Local Repository To GitHub
...
<p>You should add a screenshot of the updated repository to your pictures folder, with an explaination of what you did in your working document.</p>
    </div>
</div>
...
<p>In your working document you should include screenshots of each of your changes with a brief description of what each of them is, and a screenshot of your GitHub repository (Which MUST include your GitHub name or they will be ineligible) with the pushed updates to your pictures folder.</p>
    </div>
</div>
...
<p>There is a chance you might not see this option if your repository is private</p>
<p>If this happens click settings -> general and then scroll all the way down to the bottom until you see the "repository visibility" section. Click change visibility and then set to public - this should then give you full access to the GitHub pages section.</p>
    </div>
</div>
...
<p>Add a screenshot to your pages folder, explaining what you just did in your working Document.</p> 
    </div>
</div>
